...
const Discovery = [
  {
    ...
    title: "Safety",
    link: "#",
    icons: <ShieldCheck className="w-20 h-20" />,
...

  {
    ...
    title: "Affordable",
    link: "#",
    icons: <CircleDollarSign className="w-20 h-20" />,
  ...
  },
  {
    ...
    title: "Reliability",
    link: "#",
    icons: <Sprout className="w-20 h-20" />,
  ...
  },
  {
    ...
    link: "#",
    icons: <UsersRound className="w-20 h-20" />,
  ...
  },
  {
    ...
    title: "24/7 Support",
    link: "#",
    icons: <Headset className="w-20 h-20" />,
